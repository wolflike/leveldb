        ...
        implements SeekingIterator<Slice, Slice>
{
    ...
    public void seek(Slice targetKey)
    {
        ...
        //总结来说，就是要找到第一个大于targetKey的shortSeperator，但是不能直接通过二分法来找，因为如果用二分法找到第一个大于targetKey
        //的shortSeperator是16个点的首节点，最后一个小于targetKey的shortSeperator的后续16个节点中，可能会有比targetKey大
